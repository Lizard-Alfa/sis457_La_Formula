...
public partial class LabLaFormulaEntities : DbContext
{
    ...
    public virtual ObjectResult<Nullable<long>> paCompraRegistrar(Nullable<int> idProveedor, Nullable<int> transaccion, Nullable<System.DateTime> fecha, string detalles)
    {
        ...
        var transaccionParameter = transaccion.HasValue ?
            new ObjectParameter("transaccion", transaccion) :
            new ObjectParameter("transaccion", typeof(int));
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<long>>("paCompraRegistrar", idProveedorParameter, transaccionParameter, fechaParameter, detallesParameter);
    }
